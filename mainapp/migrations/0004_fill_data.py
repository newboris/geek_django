# Generated by Django 3.0.6 on 2020-05-17 14:24
...
def forwards_func(apps, schema_editor):
    ...
    con_model = apps.get_model("mainapp", "Location")  # Load model for make changes
...
def reverse_func(apps, schema_editor):
    ...
    con_model = apps.get_model("mainapp", "Location")

    # Delete all objects
    pro_cat_model.objects.all().delete()
    pro_model.objects.all().delete()
